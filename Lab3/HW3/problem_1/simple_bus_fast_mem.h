...
{
    unsigned index = (address-m_start_address)/4;
    unsigned addrY = index/m_width;
    unsigned addrX = index%m_width;
    mem->word_read(addrY, addrX, *data);
    ...
    , unsigned int address)
{
    ...
    unsigned addrY = index/m_width;
    unsigned addrX = index%m_width;
    mem->word_write(addrY, addrX, *data);
